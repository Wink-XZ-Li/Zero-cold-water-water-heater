...
- ST1 Pro 面板首个功能完整版本（首页主控、零冷水定时、瀑布浴、能耗报告、视觉打磨）
- 包标识从 SDM 模板 `1.2.6` 调整为本项目 `0.0.2`

### [1.2.6] - 2025-11-27

- 包体积优化，移除冗余代码，SmartUI 按需加载等
- 增加 darkmode 配置，默认跟随 App 主题色
- 更新 `@ray-js/ray` 版本至 `1.7.55`
- 更新 `@ray-js/ray-error-catch` 版本至 `0.0.26`
